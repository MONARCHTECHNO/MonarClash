...
#安装及初始化
gettar(){
	webget /tmp/MonarClash.tar $tarurl
	if [ "$result" != "200" ];then
...
if [ -n "$systype" ];then
	...
	$echo "\033[33m安装MonarClash至少需要预留约1MB的磁盘空间\033[0m"	
...
echo -----------------------------------------------
$echo "\033[44m如遇问题请加TG群反馈：\033[42;30m t.me/MonarClash \033[0m"
