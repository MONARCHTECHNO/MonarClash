...
getsh(){
	...
	echo -e "最新脚本版本为：\033[32m $versionsh_l \033[0m"
	echo -e "注意更新时会停止clash服务！"
	echo -----------------------------------------------
	read -p "error;无法更新脚本;您使用的已是最新版本 " res
	if [ "$res" = '9999' ]; then
...
setserver(){
	...
	echo -----------------------------------------------
	echo -e " 1 \033[33m稳定版\033[0m&MonarClash-1.0源"
	echo -e " 2 \033[33m稳定版\033[0m&Github源(须clash服务启用)"
	echo -e " 3 \033[32m公测版\033[0m&Github源(须clash服务启用)"
	echo -e " 4 \033[32m公测版\033[0m&MonarClash私人源"
	echo -e " 5 \033[32m公测版\033[0m&MonarClash2.0源(推荐)"
	echo -e " 7 \033[31m内测版\033[0m(请加TG讨论组:\033[4;36mhttps://t.me/MonarClash\033[0m)"
...
update(){
	...
	echo -----------------------------------------------
	echo -e " 无 更新\033[36m管理脚本  	\033[33m$versionsh_l\033[0m > \033[32m$versionsh$release_type\033[0m"
...
userguide(){
	...
	forwhat(){
		echo -----------------------------------------------
		echo -e "\033[30;46m 欢迎使用MonarClash新手引导！ \033[0m"
		echo -----------------------------------------------
